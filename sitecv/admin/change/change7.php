...
<html lang="fr-FR">
	...
	<body>
		...
		<h2 class="titre"><?= $parcours->metier ?></h2>
		<div class="sec">
			<div class="leftexp">
				<p>
			</div>
			...
			<div class="rightexp">
				...
				<a href="../delete/delete_parcours.php?id=<?= $parcours->id ?>"><p>Enlever</p>
				<a href="../modify/change_parcours.php?id=<?= $parcours->id ?>"><p>Modifier</p>
