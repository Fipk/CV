...
<html lang="fr-FR">
	...
	<body>
		<?php 
            ...
            $competence = getObjet7($db, 1, $_GET['id']);
		 ?>
		...
		<h2 class="titre"><?= $competence->name ?></h2>
		<div class="sec">
			<div class="leftexp">
				<p>
			</div>
			...
			<div class="rightexp">
				<p><?= $competence->niveaux ?></p>
				<a href="../delete/delete_competence.php?id=<?= $competence->id ?>"><p>Enlever</p>
				<a href="../modify/change_competence.php?id=<?= $competence->id ?>"><p>Modifier</p>
