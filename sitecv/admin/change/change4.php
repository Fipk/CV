...
<html lang="fr-FR">
	...
	<body>
		...
		<h2 class="titre"><?= $competences->competences ?></h2>
		<div class="sec">
			<div class="leftexp">
				<p>
			</div>
			...
			<div class="rightexp">
				<p><?= $competences->niveaux ?></p>
				<a href="../delete/delete_competences.php?id=<?= $competences->id ?>"><p>Enlever</p>
				<a href="../modify/change_competences.php?id=<?= $competences->id ?>"><p>Modifier</p>
